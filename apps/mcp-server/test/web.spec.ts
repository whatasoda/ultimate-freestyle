...
describe("Web dashboard", () => {
  it("logs in with Twitch and shows only the owner's projects", async () => {
    ...
    expect(dashboardScriptText).toContain("filmstripTop: reviewFilmstrip instanceof HTMLElement");
    expect(dashboardScriptText).toContain("reviewFilmstripList.scrollLeft = savedReviewPosition.filmstripLeft");
