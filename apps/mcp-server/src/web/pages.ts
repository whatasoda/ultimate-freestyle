...
const DASHBOARD_STYLE = String.raw`
      ...
      * { box-sizing: border-box; }
      ...
      form { margin: 0; }
      @media (min-width: 72.01rem) { main.workspace-main { width: min(98vw, 112rem); } .slide-workspace { grid-template-columns: minmax(11rem, 13rem) minmax(34rem, 1fr); gap: .8rem; } .filmstrip { position: sticky; top: .75rem; max-height: calc(100dvh - 7rem); scrollbar-gutter: stable; } .workspace-preview { position: sticky; top: .75rem; } .workspace-frame { max-height: calc(100dvh - 15rem); margin-inline: auto; } }
