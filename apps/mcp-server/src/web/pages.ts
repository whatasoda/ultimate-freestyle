       ...
       <main id="main-content" tabindex="-1" class="workspace-main">
         ...
         <div class="slide-workspace" data-workspace-asset-urls="${escapeHtml(JSON.stringify(workspaceAssetUrls))}" data-selected-component="${escapeHtml(selectedComponentId ?? "")}" data-selected-narration="${selectedNarrationSegment?.at ?? ""}">
           ...
           <aside class="inspector" id="workspace-edit-pane" role="tabpanel" aria-labelledby="mobile-tab-edit">${workspaceSlideCreator}
             <div class="mobile-inspector-tabs" role="tablist" aria-label="編集項目" hidden><button type="button" role="tab" data-inspector-pane="content" aria-controls="inspector-content">内容</button><button type="button" role="tab" data-inspector-pane="design" aria-controls="inspector-design">デザイン</button><button type="button" role="tab" data-inspector-pane="narration" aria-controls="inspector-narration">読み上げ</button><button type="button" role="tab" data-inspector-pane="structure" aria-controls="inspector-structure">構造</button><button type="button" role="tab" data-inspector-pane="quality" aria-controls="inspector-quality">品質確認</button></div>
