...
const DASHBOARD_SCRIPT_SRC = "/assets/dashboard.js?v=115";
  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      @media (max-width: 38rem) { .site-header, .account { align-items: flex-start; } .site-header { flex-direction: column; } .section-head { align-items: flex-start; flex-direction: column; } .step-control { display: grid; grid-template-columns: minmax(0, 1fr) auto minmax(0, 1fr); gap: .45rem; } .step-control button { width: 100%; min-height: 2.75rem; padding-inline: .45rem; } .step-control output { min-width: 5.5rem; } .step-control [data-grid-snap] { grid-column: 1 / -1; } }
