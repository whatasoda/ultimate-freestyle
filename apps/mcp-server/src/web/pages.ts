...
const DASHBOARD_SCRIPT_SRC = "/assets/dashboard.js?v=100";
    ...
    shell(
      ...
      `${accountHeader(options.twitchLogin, options.csrfToken)}
       <main class="workspace-main">
         ...
         ${effectiveSummary}
         <nav class="mobile-workspace-tabs" aria-label="モバイル編集表示"><button class="ghost" type="button" data-mobile-pane="preview" aria-pressed="true">プレビュー</button><button class="ghost" type="button" data-mobile-pane="edit" aria-pressed="false">編集</button><button class="ghost" type="button" data-mobile-pane="slides" aria-pressed="false">スライド一覧</button></nav>
