...
CodexとChatGPTを優先するRemote MCPがあります。`health`、`get_access_status`、研究の作成・一覧・取得・更新・評価材料取得、制作ガイドresource、3つの伴走prompt、Twitch OAuthによるフォロー期間・サブスク・運用overrideの資格判定を実装しています。
